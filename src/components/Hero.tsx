...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center px-6 pt-16 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20">
        ...
        >
          <div className="relative animate-float">
            ...
            <div className="absolute -bottom-4 -left-8 bg-white dark:bg-gray-900 rounded-xl px-4 py-2 shadow-xl border border-gray-100 dark:border-gray-800">
              <p className="text-xs text-gray-500 dark:text-gray-400">Experience</p>
              <p className="text-lg font-bold text-indigo-600 dark:text-indigo-400">4+ Years</p>
            </div>

            {/* Floating badge — projects */}
            <div className="absolute -top-4 -right-8 bg-white dark:bg-gray-900 rounded-xl px-4 py-2 shadow-xl border border-gray-100 dark:border-gray-800">
